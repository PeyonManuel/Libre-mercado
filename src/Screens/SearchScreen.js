...
const SearchScreen = (props) => {
  ...
  return error || categoryError || userError ? (
    ...
    <div className='search-ui'>
      <aside className='search-sidebar'>
        ...
        <div className='price-div'>
          <h3 className='bold width-100'>Precio</h3>
      ...
      <section className='search-results'>
        ...
        <div className='results width-100 flex-start'>
          {products
            .sort((a, b) =>
    ...
    <div class='no-results-msg-container'>
      ...
      <div>
        <h3 class='ui-search-rescue__title'>
          Escribí en el buscador lo que querés encontrar.
        </h3>
        <ul class='with-style'>
          <li>
            <strong>Escribí tu búsqueda</strong> en el campo que figura en la
            parte superior de la pantalla.
          </li>
          <li>
            <strong>Navegá por categorías de productos</strong> para encontrar
